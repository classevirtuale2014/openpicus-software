...
#define MY_DEFAULT_IP_ADDR_BYTE4        (170ul)
...
#define MY_DEFAULT_GATE_BYTE3           (33ul)
#define MY_DEFAULT_GATE_BYTE4           (254ul)

#define MY_DEFAULT_PRIMARY_DNS_BYTE1	(172ul)
#define MY_DEFAULT_PRIMARY_DNS_BYTE2	(17ul)
