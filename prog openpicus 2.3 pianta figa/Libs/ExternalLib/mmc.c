...
#define SOCKWP	(1<<14)		/* Write protect switch (RB14) */
#define SOCKINS	(1<<15)		/* Card detect switch (RB15) */
...
#define rcvr_spi_m(p)	SPIBUF = 0xFF; while (!_SPIRBF); *(p) = (BYTE)SPIBUF;
...
void disk_timerproc (void)
{
	...
	// !!!!  activate the following line if you want to use the write protect and disk check.
	//	pv = SOCKPORT & (SOCKWP | SOCKINS);	/* Sample socket switch */

	pv = 0; // disable protect and disk check
